...
public class UserCenter extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = (View)inflater.inflate(R.layout.user_layout_main, container, false);
        ...
        mainView.addJavascriptInterface(new LanWebAppInterface(((MainActivity)getActivity())), "LanJsBridge");
