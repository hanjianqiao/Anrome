...
public class SelfDetail extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        mainView.setWebViewClient(new SelfDetailWebViewClient((MainActivity) getActivity(), goodId));
        mainView.setInitialScale(25);
        mainView.loadUrl("file:///android_asset/sys_h5/detail_self.html");
